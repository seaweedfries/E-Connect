...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\earth\Downloads\Term 5 Docs\E-Connect\flask-test'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\earth\Downloads\Term 5 Docs\E-Connect\flask-test\Scripts\deactivate.nu'
